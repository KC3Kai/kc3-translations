...
const _eval = (content) => {
	...
	const stringScript = new String(content).replace(/^\#\!.*/, '')
...
const toFormattedJson = function(obj, useCrLf = false, addBom = false, ident = indentChar) {
